This script saves the current scroll position in localStorage before the page unloads and then scrolls back to that position when the page is reloaded.
